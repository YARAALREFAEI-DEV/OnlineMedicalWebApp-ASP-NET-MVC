...
namespace Next2OnlineMedicalApp.Areas.Admin.Controllers
{
    ...
    public class PatientsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PatientId,UserId,Password,Email,FirstName,LastName,PhoneNumber,DateOfBirth,Address,MedicalHistory")]Next2OnlineMedicalApp.Models.Patient patient)
        {
